# -*- encoding: utf-8 -*-
'''
@create_time: 2022/08/24 14:47:58
@author: lichunyu
'''
...
class W2nerArgs:
    ...
    dist_emb_size: int = field(default=None, metadata={"help": ""})
    type_emb_size: int = field(default=None, metadata={"help": ""})
    lstm_hid_size: int = field(default=None, metadata={"help": ""})
    conv_hid_size: int = field(default=None, metadata={"help": ""})
    bert_hid_size: int = field(default=None, metadata={"help": ""})
    biaffine_size: int = field(default=None, metadata={"help": ""})
    ffnn_hid_size: int = field(default=None, metadata={"help": ""})

    dilation: int = field(default_factory=list, metadata={"help": ""})

    emb_dropout: float = field(default=None, metadata={"help": ""})
    conv_dropout: float = field(default=None, metadata={"help": ""})
    out_dropout: float = field(default=None, metadata={"help": ""})

    use_bert_last_4_layers: bool = field(default=True, metadata={"help": ""})
    bert_name: str = field(default="bert-base-chinese", metadata={"help": ""})


def model_init(model:W2ner, **kwds):
    args = W2nerArgs(**kwds)
    model = model(args)
    return model