...
class BertRegress(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.config = BertConfig.from_pretrained('/ai/223/person/lichunyu/pretrain-models/bert-base-uncased')
        self.bert = BertModel.from_pretrained('/ai/223/person/lichunyu/pretrain-models/bert-base-uncased')
