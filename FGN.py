...
from models.crf import get_crf_zero_init
...
if __name__ == '__main__':
    ...
    batch_dict = bert_tokenizer('今天是晴天', return_tensors='pt', padding='max_length', max_length=8)
    input_ids = batch_dict['input_ids']
    attention_mask = batch_dict['attention_mask']

    cgs_tokenizer = CGS_Tokenzier.from_pretained('/root/EarleeNLP')
    # char_input_ids = cgs_tokenizer('今天是晴天')
    char_input_ids = torch.from_numpy(np.array([[1,2,3,4,5,8630]]))
